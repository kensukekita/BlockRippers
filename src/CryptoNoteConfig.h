...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 63;
...
const int      P2P_DEFAULT_PORT                              =  24436;
const int      RPC_DEFAULT_PORT                              =  24437;
...
const char* const SEED_NODES[] = { "45.5.120.202:24436", "85.25.195.151:24436" };
